...
########################################
checkPerlModules(){
MODULES="LWP::Simple JSON Data::Dumper Config::Simple Crypt::SSLeay URI XML::Twig POSIX File::Copy Archive::Extract File::Path File::Find FindBin Socket Getopt::Long Archive::Zip"
BINARIESCHECK=""
